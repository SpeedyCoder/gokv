...
import (
	...
	"github.com/SpeedyCoder/gokv/internal/sql"
)
...
// ConnectionURL: "postgres://root@localhost:26257/gokv?sslmode=disable&application_name=gokv", TableName: "Item", MaxOpenConnections: 100, Encoding: encoding.JSON
