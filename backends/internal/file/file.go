...
type Options struct {
	...
	// But it can lead to redundant and/or stale data if you switch the Encoding back and forth!
	// You also should make sure to change this when changing the Encoding,
...
// Directory: "gokv", Encoding: encoding.JSON
